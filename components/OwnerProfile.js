            ...
            <div className="text-center md:text-left space-y-4 relative">
              ...
              <div className="flex justify-center md:justify-start space-x-6 mt-8">
                ...
                <a
                  ...
                  rel="noopener noreferrer"
                  aria-label="Visit Devendra Singh's Twitter profile"
                  className="text-blue-500 hover:text-yellow-500 transform hover:scale-125 transition-all duration-300"
                >
                  <FaTwitter size={35} />
                </a>
                <a
                  ...
                  rel="noopener noreferrer"
                  aria-label="Visit Devendra Singh's Facebook profile"
                  className="text-blue-800 hover:text-yellow-500 transform hover:scale-125 transition-all duration-300"
                >
                  <FaFacebook size={35} />
                </a>
              </div>
